...
se asumira:
- la memoria tiene capacidad de 2 elevado a la N
- se divide en bloques consecutivos de B palabras
- el temaño del bloque es una potencia de 2
- se tendra la cantidad de 2 elevado a la N dividido B
